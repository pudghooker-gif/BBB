...
- API key rotation/revocation now has audited CLI coverage with mandatory actor/reason. Production UX, RBAC, and step-up controls are still required before broad admin exposure.
