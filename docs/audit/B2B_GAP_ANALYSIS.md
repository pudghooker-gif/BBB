...
- B2B launch session model, operator-scoped game availability/session guard, provider adapter contract, provider-backed session close, and public launcher bridge to the legacy launcher.
