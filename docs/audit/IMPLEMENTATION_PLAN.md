...
- Keep expanding the tenant-facing signed read-only `/api/b2b/v1/portal` UI beyond the current credentials, game assignments, sessions, transactions, settlements, cases, and docs workflow pages into callback settings and richer report drilldowns.
