...
- `php -v`: PHP 7.4.33.
- `composer validate --strict`: passes after adding proprietary license metadata; unused `laravel/ui`, legacy `fideloper/proxy`, and unused SMS.to Laravel wrapper direct dependencies were removed during dependency-trim work.
