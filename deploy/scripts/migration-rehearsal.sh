...
MIGRATION_REHEARSAL_ARTIFACT_DIR="${MIGRATION_REHEARSAL_ARTIFACT_DIR:-${ARTIFACT_DIR:-${APP_DIR}/storage/logs}}"
STAMP="$(date -u +%Y%m%dT%H%M%SZ)"
LOG_FILE="${MIGRATION_REHEARSAL_ARTIFACT_DIR}/b2b-migration-rehearsal-${STAMP}.log"
...
mkdir -p "${MIGRATION_REHEARSAL_ARTIFACT_DIR}"
cd "${APP_DIR}"
