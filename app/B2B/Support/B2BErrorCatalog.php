...
class B2BErrorCatalog
{
    private static $errors = [
        ...
        'GAME_UNDER_MAINTENANCE' => [503, 'Game is temporarily under maintenance.'],
        ...
        'PROVIDER_NOT_IMPLEMENTED' => [501, 'Provider adapter is not implemented.'],
        'PROVIDER_REQUEST_NOT_FOUND' => [404, 'Provider request was not found.'],
